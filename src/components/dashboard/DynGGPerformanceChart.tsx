...
interface DynGGPerformanceChartProps {
...
const DynGGPerformanceChart: React.FC<DynGGPerformanceChartProps> = ({
  timeRange = "7d",
  onTimeRangeChange = () => {},
}) => {
    ...
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <div>
          ...
          <CardDescription>
            Distribution of peak pressure values across shots
          </CardDescription>
        </div>
...
export default DynGGPerformanceChart;
